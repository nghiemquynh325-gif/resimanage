/**
 * EASY UPDATE GUIDE FOR HouseholdFormModal.tsx
 * 
 * Tìm và thay thế các đoạn code sau trong file:
 * components/households/HouseholdFormModal.tsx
 */

// ============================================
// 1. SCHEMA (Tìm dòng 14-36, thay thế toàn bộ)
// ============================================
...
// ============================================
// 2. DEFAULT VALUES (Tìm dòng 81-94, thay thế toàn bộ)
// ============================================
defaultValues: {
    headOfHouseholdId: '',
        unit: '',
...
// ============================================
// 3. RESET WHEN EDITING (Tìm dòng 106-119, thay thế toàn bộ)
// ============================================
reset({
...
// ============================================
// 4. RESET WHEN CREATING NEW (Tìm dòng 123-136, thay thế toàn bộ)
// ============================================
reset({
    headOfHouseholdId: '',
    unit: '',
...
// ============================================
// 5. PAYLOAD (Tìm dòng 201-221, thay thế toàn bộ)
// ============================================
...
// ============================================
// 6. FORM FIELDS - THÊM SAU BUSINESS MANAGER SELECT
// Tìm phần "Người quản lý" select (khoảng dòng 400+)
// Thêm đoạn code này NGAY SAU đó:
// ============================================
